...
<div class="container">
  <div class="row text-xs-center">
    <div class="col-md-12 text-center">
      ...
      <br>
      <p class="textoHistoria text-dark">{{ $card -> history_description}}</p>
  </div>
</div>
</section>
<!-- end Historia -->
...
<section id="vestimenta">
  <div class="container">
    <div class="row text-xs-center p-t-1 p-b-4">
      <div class="col-md-12 text-center">
        <br>
        <h3 class="titulohashtag ">{{ $card -> dresscode_title}}</h3>
            ...
            <div class="row text-xs-center p-t-1 p-b-3">
              <div class="col-md-12 text-center">
                ...
                <div class="divtexto" wire:ignore>
                  ...
                  <span class="textoregalo">{{$card -> gift_description}}</span>
                </div>
                ...
                <br>
                <span class="datosbancarios">{{$card -> gift_bank}}</span>

...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@200&display=swap" rel="stylesheet">
  ...
  <link rel="stylesheet" href="{{asset('/build/assets/template/chic/chic.css')}}">
...
<!--Portada-->
<div id="guille" class="container-fluid portada" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/romantic-3.jpg' ) }});">
  <div class="row vh-100">
    <div class="overlay"></div>
    <div class="col-1">
      <img class="img1" src="https://eventdate.es/wp-content/uploads/2022/09/flor1-izquierda.png" alt="">
    </div>
    ...
    <div class="col-1">
      <img class="img2" src="https://eventdate.es/wp-content/uploads/2022/09/flor1-derecha.png" alt="">
    </div>
  </div>
</div>
...
<section id="hashtag" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/romantic-3.jpg' ) }});">
  <div class="container">
  ...
  <!--End Galeria-->
    ...
    <!-- <section id="recomendado">
      ...
      <section id="canciones">
        ...
        <div id="main-bg" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/romantic-3.jpg' ) }});">
          <div class="container">
            <div class="row">

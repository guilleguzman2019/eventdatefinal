...
@section('css')
  ...
  <link rel="stylesheet" href="{{asset('/build/assets/template/boho/boho.css')}}">
...
<!--Portada-->
<div id="guille" class="container-fluid portada" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/MODELO-BODA-1.jpg' ) }});">
  <div class="row vh-100">
    <div class="overlay"></div>
    <div class="col-1">
      <img class="img1" src="https://eventdate.es/wp-content/uploads/2022/08/hojas.png" alt="">
    </div>
    <div class="col-10 pt-5 pb-5">
      <div id="titulos" class="d-flex justify-content-center align-items-center h-100">
        <div class="text-center">
          <input wire:model.defer="ArrayInvitacion.title" class="text-light tituloPortada transparente" type="text" value="$ArrayInvitacion['title']">
    ...
    <div class="col-1">
      <img class="img2" src="https://eventdate.es/wp-content/uploads/2022/08/hojas-2.png" alt="">
    </div>
  </div>
</div>
...
<div id="contador" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/MODELO-BODA-1-1.jpg') }});">
  ...
  <div class="container">
    <div class="row text-xs-center p-t-1 p-b-4">
      <div class="col-md-12 text-center">
        ...
        <input wire:model.defer="ArrayInvitacion.dresscode_title" type="text" class="titulohashtag transparente text-dark" value="Codigo de Vestimenta">
        <br>
        <br>
      ...
      <section id="canciones">
        ...
        <section id="testigos">
          <div class="container-fluid">
            <div class="row text-xs-center">
              <div class="col-12 text-center">
                <input  type="text" class="titulopadrinos transparente text-dark" value="Testigos" style="width: 100%;">
                ...
                <div class="carousel-wrap"  wire:ignore>
                      ...
                      @foreach ($types_testigo as $p)
                        ...
                        <div class="text-center">
                          ...
                          <div class="card-body">
                            <h5 class="card-name-padrino text-dark">{{$p -> name}}</h5>
                            <span class="card-relacion text-dark">{{$p -> relationship}}</span>
                            <br>
                          </div>
                        </div>
        ...
        <div id="main-bg" style="background-image: url({{ asset(($imgPortadaDesktop) ? $imgPortadaDesktop -> temporaryUrl() : 'https://eventdate.es/wp-content/uploads/jet-engine-forms/1/2022/09/MODELO-BODA-1-1.jpg' ) }});">
          <div class="container">
            <div class="row">

...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'arrayEvent.title' => 'titulo',
        'arrayEvent.start_date' => 'fecha',
        'arrayEvent.place_name' => 'Nombre del lugar',
        'arrayEvent.address' => 'direccion',
        'arrayEvent.google_maps' => 'Link de maps',

        'imageGaleria' => 'Imagen',

        'imagenRegalo' => 'Imagen',
        'arrayRegalo.title' => 'titulo',
        'arrayRegalo.description' => 'descripcion',
        'arrayRegalo.precio' => 'precio',
        'arrayRegalo.link' => 'link',

        'imagePadrinos' => 'Imagen',
        'arrayPadrinos.name' => 'nombre',
        'arrayPadrinos.type' => 'tipo',
        'arrayPadrinos.relationship' => 'relacion',
